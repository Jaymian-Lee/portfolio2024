const { STREAM_CHANNEL, STREAM_MESSAGES_KEY, json, kvCommand, parsePlatforms } = require('./stream/_shared');
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    return json(res, 200, { channel: STREAM_CHANNEL, platforms, messages: all });
  } catch {
